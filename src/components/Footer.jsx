          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-right">
            ...
            <div className="space-y-5 text-right">
               ...
               <ul className="space-y-3 font-medium text-right text-base">
                 <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors flex items-center gap-2 justify-start"><span className="w-2 h-2 bg-blue-500 rounded-full"></span> الرئيسية</a></li>
                 <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors flex items-center gap-2 justify-start"><span className="w-2 h-2 bg-blue-500 rounded-full"></span> المعرض والفعاليات</a></li>
                 <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors flex items-center gap-2 justify-start"><span className="w-2 h-2 bg-blue-500 rounded-full"></span> المركز الإعلامي</a></li>
                 <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors flex items-center gap-2 justify-start"><span className="w-2 h-2 bg-blue-500 rounded-full"></span> تواصل معنا</a></li>
               </ul>
            </div>
            ...
            <div className="space-y-5 text-right">
               ...
               <ul className="space-y-4 font-medium text-gray-400 text-right text-base">
                 ...
                 <li className="flex items-center gap-3 justify-start">
                   ...
                   <span dir="ltr" className="text-right">+20 123 456 7890</span>
                 </li>
                 <li className="flex items-center gap-3 justify-start">
