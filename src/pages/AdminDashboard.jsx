    ...
    <div className="min-h-screen bg-slate-50 flex" dir="rtl" style={{ fontFamily: "'Cairo', sans-serif" }}>
      ...
      <div className="w-72 bg-[#26462C] text-white flex flex-col shrink-0 border-l border-slate-100/10 h-screen sticky top-0 overflow-y-auto z-30">
        ...
        <div className="p-6 border-b border-white/5 flex items-center gap-3">
          ...
          <div>
            <h2 className="text-base font-black text-white tracking-tight">قمة جامعة المنيا</h2>
            <span className="text-[10px] text-slate-300 font-bold block mt-0.5">لوحة التحكم والمتابعة 2026</span>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-white/5 bg-black/10">
          <div className="flex items-center gap-2 text-[10px] text-slate-400 font-bold">
            ...
            <span>رقم الإصدار: v1.0.4 - 2026</span>
          </div>
        </div>
      </div>
