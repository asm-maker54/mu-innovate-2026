...
const AboutPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen pt-16 bg-[#f8fafc] font-cairo">
      {/* Old Web Summit Style Hero moved here */}
      <section className="relative py-8 overflow-hidden bg-gradient-to-br from-[#0a1628] via-[#0f2847] to-[#1a1040]">
        ...
        <div className="max-w-[95rem] mx-auto px-3 sm:px-4 lg:px-6 relative z-10">
          <div className="flex flex-col lg:flex-row-reverse gap-4 items-stretch">
            ...
            {/* Left: Main Showcase Image/Slideshow */}
            <div className="flex-1 lg:flex-[3] relative group">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-black/40 aspect-[16/9] bg-gray-900">
                ...
                <div className="absolute bottom-4 right-4 flex items-center gap-2 z-20">
                  ...
                  <button className="w-10 h-10 rounded-full bg-white/20 backdrop-blur-md text-white flex items-center justify-center hover:bg-white/30 transition-colors">
                ...
                {/* Summit branding overlay on image */}
                ...
                <div className="p-6 flex flex-col flex-1 justify-between" dir="rtl">
                  <div>
                    <h2 className="text-white text-2xl md:text-3xl font-bold leading-snug mb-3">
                      "أكبر قمة للابتكار وريادة الأعمال في صعيد مصر"
                    </h2>
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    >
                      {isRtl ? 'انضم إلى شبكتنا' : 'Join our network'}
                    ...
                    >
                      {isRtl ? 'استكشف الابتكار' : 'Explore Innovation'}
                    </Link>
                  </div>
                </div>
              </div>
